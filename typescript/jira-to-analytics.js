...
var convertToJson = function (response) {
    return response.json();
};
exports.convertToJson = convertToJson;
var getJsonFromUrl = function (url, headers) {
...
var getIssues = function (apiUrl, projects, issueTypes, filters, workflow, startDate, endDate, customJql, startIndex, batchSize, username, password) {
    return __awaiter(this, void 0, Promise, function* () {
        var queryUrl = query_builder_1.buildJiraSearchQueryUrl(apiUrl, projects, issueTypes, filters, workflow, startDate, endDate, customJql, startIndex, batchSize);
...
var getMetadata = function (apiUrl, projects, issueTypes, filters, workflow, startDate, endDate, customJql, startIndex, batchSize, username, password) {
    return __awaiter(this, void 0, Promise, function* () {
        var queryUrl = query_builder_1.buildJiraSearchQueryUrl(apiUrl, projects, issueTypes, filters, workflow, startDate, endDate, customJql, startIndex, batchSize);
...
"use strict";
var buildJiraSearchQueryUrl = function (apiRootUrl, projects, issueTypes, filters, workflowKeyVal, startDate, endDate, customJql, startIndex, batchSize) {
    if (issueTypes === void 0) { issueTypes = []; }
    if (filters === void 0) { filters = []; }
    if (workflowKeyVal === void 0) { workflowKeyVal = {}; }
    if (startIndex === void 0) { startIndex = 0; }
...
var buildJiraGetProjectsUrl = function (apiRootUrl) {
    var url = apiRootUrl + "/project";
    return url;
};
exports.buildJiraGetProjectsUrl = buildJiraGetProjectsUrl;
var buildJiraGetWorkflowsUrl = function (project, apiRootUrl) {
    var url = apiRootUrl + "/project/" + project + "/statuses";
    return url;
};
