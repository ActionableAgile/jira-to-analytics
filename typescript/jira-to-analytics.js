(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.rawjs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
...
var run = function (cliArgs) {
    return __awaiter(this, void 0, Promise, function* () {
        ...
        var settings = {};
        try {
            var yamlConfig = js_yaml_1.safeLoad(fs.readFileSync(jiraConfigPath, 'utf8'));
            settings = yamlConfig;
        ...
        // Import data
        var jiraExtractor = new main_1.JiraExtractor()
            .importSettings(settings, 'yaml')
            .setBatchSize(25);
        try {
            var workItems = yield jiraExtractor.extractAll(updateProgressHook);
            // Export data
            var data = void 0;
            if (outputType === 'CSV') {
                data = yield jiraExtractor.toCSV(workItems);
            }
...
},{"./main":15,"fs":undefined,"js-yaml":62,"progress":118,"yargs":140}],2:[function(require,module,exports){
"use strict";
...
},{"isomorphic-fetch":61}],3:[function(require,module,exports){
"use strict";
var WorkItem = (function () {
    function WorkItem(id, stageDates, name, type, attributes) {
        this.Id = id;
...
},{"./jira/extractor":14}],5:[function(require,module,exports){
"use strict";
...
var parseAttributeArray = function (attributeArray) {
    var parsedAttributes = attributeArray.map(function (attributeArrayElement) {
        return parseAttribute(attributeArrayElement);
    });
    if (parsedAttributes.length === 0) {
        return '';
    }
    var result = parsedAttributes.length === 1 ? parsedAttributes[0] : "[" + parsedAttributes.join(';') + "]";
    return result;
};
exports.parseAttributeArray = parseAttributeArray;
...
exports.toCSV = toCSV;
var toSerializedArray = function (workItems, stages, attributes, withHeader) {
    if (withHeader === void 0) { withHeader = true; }
...
exports.toSerializedArray = toSerializedArray;
...
var extractBatch = function (apiUrl, projects, issueTypes, filters, workflowKeyVal, attributesKeyVal, username, password, startIndex, batchSize) {
    return __awaiter(this, void 0, void 0, function* () {
        if (startIndex === void 0) { startIndex = 0; }
        if (batchSize === void 0) { batchSize = 1; }
        var issues = yield jira_adapter_1.getIssues(apiUrl, projects, issueTypes, filters, startIndex, batchSize, username, password);
...
var extractAll = function (apiUrl, projects, issueTypes, filters, workflow, attributes, batchSize, hook, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        if (batchSize === void 0) { batchSize = 25; }
        if (hook === void 0) { hook = function () { }; }
        var metadata = yield jira_adapter_1.getMetadata(apiUrl, projects, issueTypes, filters, 0, 1, username, password);
        ...
        for (var i = 0; i < totalBatches; i++) {
            ...
            var workItemBatch = yield extractBatch(apiUrl, projects, issueTypes, filters, workflow, attributes, username, password, start, batchSize);
...
"use strict";
var yaml_converter_1 = require('./yaml-converter');
var importConfig = function (config, source) {
    switch (source.toUpperCase()) {
        case 'YAML':
            var parsedSettings = yaml_converter_1.convertYamlToJiraSettings(config);
            var Connection = parsedSettings.Connection, Attributes = parsedSettings.Attributes, Criteria = parsedSettings.Criteria, Workflow = parsedSettings.Workflow;
            var jiraSettings = {
...
},{"./yaml-converter":13}],9:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var getIssues = function (apiUrl, projects, issueTypes, filters, startIndex, batchSize, username, password) {
    return __awaiter(this, void 0, Promise, function* () {
        var queryUrl = query_builder_1.buildJiraSearchQueryUrl(apiUrl, projects, issueTypes, filters, startIndex, batchSize);
        var result = yield makeRequest(queryUrl, username, password);
        if (result.issues) {
...
var getMetadata = function (apiUrl, projects, issueTypes, filters, startIndex, batchSize, username, password) {
    return __awaiter(this, void 0, Promise, function* () {
        var queryUrl = query_builder_1.buildJiraSearchQueryUrl(apiUrl, projects, issueTypes, filters, startIndex, batchSize);
        var metadata = yield makeRequest(queryUrl, username, password);
        return metadata;
    });
};
exports.getMetadata = getMetadata;
var testConnection = function (apiUrl, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        var url = query_builder_1.buildJiraGetProjectsUrl(apiUrl);
        var projects = yield makeRequest(url, username, password);
        return projects.length ? true : false;
    });
};
exports.testConnection = testConnection;
var getProjects = function (apiUrl, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        var url = query_builder_1.buildJiraGetProjectsUrl(apiUrl);
        var projects = yield makeRequest(url, username, password);
        return projects;
...
var getWorkflows = function (project, apiUrl, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        var url = query_builder_1.buildJiraGetWorkflowsUrl(apiUrl, project);
        var workflows = yield makeRequest(url, username, password);
        return workflows;
    });
};
exports.getWorkflows = getWorkflows;
var makeRequest = function (url, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        var headers = http_1.getHeaders(username, password);
        var json = yield http_1.getJsonFromUrl(url, headers);
        return json;
    });
};
exports.makeRequest = makeRequest;

},{"../../../core/http":2,"./query-builder":10}],10:[function(require,module,exports){
"use strict";
var buildJiraSearchQueryUrl = function (apiRootUrl, projects, issueTypes, filters, startIndex, batchSize) {
    ...
    if (issueTypes.length > 0) {
        var typeClause = "issuetype in (" + issueTypes.join(',') + ")";
        clauses.push(typeClause);
    }
    var filterClauses = filters.map(function (filter) { return ("filter=\"" + filter + "\""); });
    clauses.push.apply(clauses, filterClauses);
    var jql = clauses.join(' AND ') + " order by key";
    var query = apiRootUrl + "/search?jql=" + encodeURIComponent(jql) + "&startAt=" + startIndex + "&maxResults=" + batchSize + "&expand=changelog";
    return query;
};
exports.buildJiraSearchQueryUrl = buildJiraSearchQueryUrl;
var buildJiraGetWorkflowsUrl = function (apiRootUrl, project) {
    return buildJiraGetProjectsUrl(apiRootUrl, project, 'statuses');
};
exports.buildJiraGetWorkflowsUrl = buildJiraGetWorkflowsUrl;
var buildJiraGetProjectsUrl = function (apiRootUrl, project, additionalProjectResource) {
    if (project === void 0) { project = ''; }
    if (additionalProjectResource === void 0) { additionalProjectResource = ''; }
    if (project) {
...
exports.buildJiraGetProjectsUrl = buildJiraGetProjectsUrl;

},{}],11:[function(require,module,exports){
"use strict";
var getStagingDates = function (issue, workflow) {
    // get this out of here, yaml schema shouldnt be coupled to business logic
    var createInFirstStage = workflow[Object.keys(workflow)[0]].includes('(Created)');
    var resolvedInLastStage = workflow[Object.keys(workflow)[Object.keys(workflow).length - 1]].includes('(Resolved)');
    var stages = Object.keys(workflow);
    var stageMap = stages.reduce(function (map, stage, i) {
        return workflow[stage].reduce(function (map, stageAlias) {
...
var populateStages = function (issue, stageMap, stageBins, unusedStages) {
    ...
    issue.changelog.histories.forEach(function (history) {
        history.items.forEach(function (historyItem) {
            ...
            //  (lumpsthem together);
            var customAttributes = ['Epic Status'];
...
var filterAndFlattenStagingDates = function (stageBins) {
    ...
    var stagingDates = stageBins.map(function (stageBin, idx) {
        ...
        if (validStageDates.length) {
            ...
            var earliestStageDate = validStageDates[0];
...
"use strict";
var work_item_1 = require('../../../core/work-item');
var staging_parser_1 = require('./staging-parser');
var attribute_parser_1 = require('./attribute-parser');
var convertIssuesToWorkItems = function (issues, workflow, attributes) {
    var workItems = issues.map(function (issue) { return convertIssueToWorkItem(issue, workflow, attributes); });
    return workItems;
};
exports.convertIssuesToWorkItems = convertIssuesToWorkItems;
var convertIssueToWorkItem = function (issue, workflow, attributes) {
    var key = issue.key;
    var name = issue.fields['summary'];
    var stagingDates = staging_parser_1.getStagingDates(issue, workflow);
    var type = issue.fields.issuetype.name ? issue.fields.issuetype.name : '';
    var requestedAttributeSystemNames = Object.keys(attributes).map(function (key) { return attributes[key]; });
    var attributesKeyVal = attribute_parser_1.getAttributes(issue.fields, requestedAttributeSystemNames);
    var workItem = new work_item_1.WorkItem(key, stagingDates, name, type, attributesKeyVal);
    return workItem;
};
exports.convertIssueToWorkItem = convertIssueToWorkItem;

},{"../../../core/work-item":3,"./attribute-parser":5,"./staging-parser":11}],13:[function(require,module,exports){
"use strict";
var restApiPath = '/rest/api/latest';
var buildApiUrl = function (rootUrl) { return ("" + rootUrl + restApiPath); };
var convertYamlToJiraSettings = function (config) {
    var jiraSettings = {};
    ...
    if (config.legacy) {
        var Projects = convertCsvStringToArray(config.Criteria.Projects); // legacy yaml is Projects (with an s)
        var IssueTypes = convertCsvStringToArray(config.Criteria.Types); // legacy yaml is Types
        var ValidResolutions = convertCsvStringToArray(config.Criteria['Valid resolutions']); // not used in legacy
        ...
        var criteria = { Projects: Projects, IssueTypes: IssueTypes, Filters: Filters, };
        jiraSettings.Criteria = criteria;
    }
    else {
        var Projects = convertToArray(config.Criteria.Project); // cur yaml is Project
        var IssueTypes = convertToArray(config.Criteria['Issue types']); // cur yaml is Issue types
        var ValidResolutions = convertToArray(config.Criteria['Valid resolutions']);
        var Filters = convertToArray(config.Criteria.Filters);
        var JQL = config.Criteria.JQL ? config.Criteria.JQL : '';
        var criteria = { Projects: Projects, IssueTypes: IssueTypes, Filters: Filters, };
        jiraSettings.Criteria = criteria;
    }
    var workflow = config.legacy
...
var convertCsvStringToArray = function (s) {
...
var jira_adapter_1 = require('./components/jira-adapter');
var extract_1 = require('./components/extract');
var import_config_1 = require('./components/import-config');
var JiraExtractor = (function () {
    function JiraExtractor(config) {
        this.config = null;
        this.extractAll = function (statusHook) {
            return __awaiter(this, void 0, void 0, function* () {
                var batchSize = this.batchSize || 25;
                var hook = statusHook || (function () { });
                var _a = this.destructureConfig(this.config), apiUrl = _a.apiUrl, projects = _a.projects, issueTypes = _a.issueTypes, filters = _a.filters, workflow = _a.workflow, attributes = _a.attributes, username = _a.username, password = _a.password;
                return extract_1.extractAll(apiUrl, projects, issueTypes, filters, workflow, attributes, batchSize, hook, username, password);
            });
        };
        this.extractBatch = function (batchSize, startIndex) {
            return __awaiter(this, void 0, void 0, function* () {
                if (startIndex === void 0) { startIndex = 0; }
                var _a = this.destructureConfig(this.config), apiUrl = _a.apiUrl, projects = _a.projects, issueTypes = _a.issueTypes, filters = _a.filters, workflow = _a.workflow, attributes = _a.attributes, username = _a.username, password = _a.password;
                return extract_1.extractBatch(apiUrl, projects, issueTypes, filters, workflow, attributes, username, password, startIndex, batchSize);
            });
        };
        this.testConnection = jira_adapter_1.testConnection;
        this.getProjects = jira_adapter_1.getProjects;
        this.getWorkflows = jira_adapter_1.getWorkflows;
        this.getIssues = jira_adapter_1.getIssues;
        this.getMetadata = jira_adapter_1.getMetadata;
        this.config = config;
    }
    ;
    JiraExtractor.prototype.setConfig = function (c) {
        this.config = c;
        return this;
    };
    ;
    JiraExtractor.prototype.setBatchSize = function (x) {
        this.batchSize = x;
        return this;
    };
    ;
    JiraExtractor.prototype.importSettings = function (configObjToImport, source) {
    ...
    JiraExtractor.prototype.destructureConfig = function (config) {
        ...
        return {
            apiUrl: apiUrl, projects: projects, issueTypes: issueTypes, filters: filters, workflow: workflow, attributes: attributes, username: username, password: password,
        };
    };
    ;
    ...
    JiraExtractor.prototype.toSerializedArray = function (workItems, withHeader) {
        return exporter_1.toSerializedArray(workItems, Object.keys(this.config.Workflow), this.config.Attributes, withHeader);
    };
    ;
    return JiraExtractor;
}());
exports.JiraExtractor = JiraExtractor;
;

},{"./components/exporter":6,"./components/extract":7,"./components/import-config":8,"./components/jira-adapter":9}],15:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
__export(require('./lib/extractors/extractors'));

},{"./lib/extractors/extractors":4}],16:[function(require,module,exports){
'use strict';
...
},{"string-width":130,"strip-ansi":131,"wrap-ansi":136}],20:[function(require,module,exports){
'use strict';
...
},{"number-is-nan":108}],21:[function(require,module,exports){
'use strict';
...
},{"./iconv-loader":23,"iconv-lite":53}],23:[function(require,module,exports){
'use strict';
...
},{"is-arrayish":56,"util":undefined}],25:[function(require,module,exports){
'use strict';
...
},{"path":undefined,"path-exists":113,"pinkie-promise":116}],26:[function(require,module,exports){
'use strict';
...
},{"./git-host-info.js":31}],33:[function(require,module,exports){
'use strict'
var url = require('url')
var gitHosts = require('./git-host-info.js')
...
},{"./git-host-info.js":31,"./git-host.js":32,"url":undefined}],34:[function(require,module,exports){
"use strict"
...
},{"./tables/big5-added.json":41,"./tables/cp936.json":42,"./tables/cp949.json":43,"./tables/cp950.json":44,"./tables/eucjp.json":45,"./tables/gb18030-ranges.json":46,"./tables/gbk-added.json":47,"./tables/shiftjis.json":48}],36:[function(require,module,exports){
"use strict"
...
},{"./dbcs-codec":34,"./dbcs-data":35,"./internal":37,"./sbcs-codec":38,"./sbcs-data":40,"./sbcs-data-generated":39,"./utf16":49,"./utf7":50}],37:[function(require,module,exports){
"use strict"
...
},{"string_decoder":undefined}],38:[function(require,module,exports){
"use strict"
...
},{"buffer":undefined,"stream":undefined}],53:[function(require,module,exports){
"use strict"
...
},{"../encodings":36,"./bom-handling":51,"./extend-node":52,"./streams":54}],54:[function(require,module,exports){
"use strict"
...
},{"stream":undefined}],55:[function(require,module,exports){
'use strict';
...
},{"builtin-modules":17}],58:[function(require,module,exports){
'use strict';
var numberIsNan = require('number-is-nan');
...
},{"number-is-nan":108}],59:[function(require,module,exports){
'use strict';
...
},{"node-fetch":96}],62:[function(require,module,exports){
'use strict';
...
},{"../type":75}],77:[function(require,module,exports){
'use strict';
...
},{"../common":64,"../type":75}],79:[function(require,module,exports){
'use strict';
...
},{"../common":64,"../type":75}],80:[function(require,module,exports){
'use strict';
...
},{"../../type":75}],81:[function(require,module,exports){
'use strict';
...
},{"./lcid.json":93,"invert-kv":55}],93:[function(require,module,exports){
module.exports={
	"af_ZA": 1078,
	"am_ET": 1118,
	"ar_AE": 14337,
...
},{"graceful-fs":28,"parse-json":110,"path":undefined,"pify":115,"pinkie-promise":116,"strip-bom":132}],95:[function(require,module,exports){
/**
...
},{"./lib/body":97,"./lib/fetch-error":98,"./lib/headers":99,"./lib/request":100,"./lib/response":101,"http":undefined,"https":undefined,"stream":undefined,"url":undefined,"zlib":undefined}],97:[function(require,module,exports){
...
},{"./fetch-error":98,"encoding":22,"is-stream":59,"stream":undefined}],98:[function(require,module,exports){
...
},{"./body":97,"./headers":99,"url":undefined}],101:[function(require,module,exports){
...
},{"./body":97,"./headers":99,"http":undefined}],102:[function(require,module,exports){
...
},{"./extract_description":102,"./typos":106,"hosted-git-info":33,"is-builtin-module":57,"semver":124,"url":undefined,"validate-npm-package-license":133}],104:[function(require,module,exports){
var util = require("util")
...
},{"./warning_messages.json":107,"util":undefined}],105:[function(require,module,exports){
...
},{"./fixer":103,"./make_warning":104}],106:[function(require,module,exports){
module.exports={
  "topLevel": { 
...
},{"child_process":undefined,"lcid":92}],110:[function(require,module,exports){
'use strict';
...
},{"./vendor/parse":111,"error-ex":24}],111:[function(require,module,exports){
/*
...
},{"./unicode":112}],112:[function(require,module,exports){
...
},{"fs":undefined,"pinkie-promise":116}],114:[function(require,module,exports){
'use strict';
var fs = require('graceful-fs');
var Promise = require('pinkie-promise');
var pify = require('pify');
...
},{"graceful-fs":28,"pify":115,"pinkie-promise":116}],115:[function(require,module,exports){
'use strict';
...
},{"pinkie":117}],117:[function(require,module,exports){
'use strict';
...
},{"./lib/node-progress":119}],119:[function(require,module,exports){
/*!
 * node-progress
...
},{"find-up":25,"read-pkg":121}],121:[function(require,module,exports){
'use strict';
var path = require('path');
...
},{"load-json-file":94,"normalize-package-data":105,"path":undefined,"path-type":114}],122:[function(require,module,exports){
'use strict';
...
},{"fs":undefined,"path":undefined}],123:[function(require,module,exports){
...
},{"spdx-license-ids":129}],127:[function(require,module,exports){
var parser = require('./parser.generated.js').parser

module.exports = function(argument) {
  return parser.parse(argument) }

},{"./parser.generated.js":128}],128:[function(require,module,exports){
...
},{"fs":undefined,"path":undefined}],129:[function(require,module,exports){
module.exports=[
  "Glide",
  "Abstyles",
  "AFL-1.1",
...
},{"code-point-at":20,"is-fullwidth-code-point":58,"strip-ansi":131}],131:[function(require,module,exports){
'use strict';
...
},{"ansi-regex":16}],132:[function(require,module,exports){
'use strict';
...
},{"is-utf8":60}],133:[function(require,module,exports){
...
},{"spdx-correct":126,"spdx-expression-parse":127}],134:[function(require,module,exports){
'use strict'
...
},{"tty":undefined}],136:[function(require,module,exports){
'use strict';
var stringWidth = require('string-width');
...
},{"string-width":130}],137:[function(require,module,exports){
var fs = require('fs')
var path = require('path')
var util = require('util')
...
},{"fs":undefined,"path":undefined,"util":undefined}],138:[function(require,module,exports){
...
},{"./lib/tokenize-arg-string":139,"camelcase":18,"lodash.assign":95,"path":undefined,"util":undefined}],139:[function(require,module,exports){
...
},{"./yargs":146}],141:[function(require,module,exports){
...
},{"path":undefined,"require-directory":122,"util":undefined,"which-module":134}],142:[function(require,module,exports){
(function (__dirname){
const fs = require('fs')
const path = require('path')
...
},{"fs":undefined,"path":undefined}],143:[function(require,module,exports){
...
},{"./obj-filter":143,"cliui":19,"decamelize":21,"set-blocking":125,"string-width":130,"window-size":135}],145:[function(require,module,exports){
const objFilter = require('./obj-filter')
...
},{"./obj-filter":143}],146:[function(require,module,exports){
(function (__dirname){
...
},{"./lib/command":141,"./lib/completion":142,"./lib/obj-filter":143,"./lib/usage":144,"./lib/validation":145,"assert":undefined,"get-caller-file":26,"lodash.assign":95,"os-locale":109,"path":undefined,"read-pkg-up":120,"require-main-filename":123,"set-blocking":125,"window-size":135,"y18n":137,"yargs-parser":138}]},{},[1])(1)
});